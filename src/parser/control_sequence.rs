...
use super::{textoken::TexToken, nodes::Color, error::{ParseResult, ParseError}, macros::CommandCollection};
...
fn parse_from_tokens<'a, I : Iterator<Item = TexToken<'a>>>(mut token_stream : I, custom_commands : &CommandCollection) -> ParseResult<RGBA> {
